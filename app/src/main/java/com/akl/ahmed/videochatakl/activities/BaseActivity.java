...
import com.akl.ahmed.videochatakl.App;
...
import com.quickblox.akl.core.gcm.GooglePlayServicesHelper;
import com.quickblox.akl.core.ui.activity.CoreBaseActivity;
import com.quickblox.akl.core.utils.ErrorUtils;
    ...
    protected void showErrorSnackbar(@StringRes int resId, Exception e,
        ...
        if (getSnackbarAnchorView() != null) {
            ErrorUtils.showSnackbar(getSnackbarAnchorView(), resId, e,
                    com.quickblox.akl.core.R.string.dlg_retry, clickListener);
        }
    }
